...
<jsp:include page="basic/header.jsp" /> 
    ...
    <form class="fit" method="post" action="edit_income">  
   	...
   	<input type="hidden" value="<%= td.getTransaction_detail_id() %>"name="tdid">     
        <table>  
            ...
            <tr>
                <td>
                    <div class="form-floating">  
                            <input type="text" name="product_name" id="product_name" class="form-control registered" value="<%= td.getAssets().getProduct_name() %>"  placeholder="ชื่อสินค้า" style="width: 215px;" readonly>
                            <label for="floating">ชื่อสินค้า</label>             
                      </div>
                </td>
                <td>
                     <div class="form-floating">
                        <input type="text" name="asset_price" id="asset_price" class="form-control registered" value="<%= td.getAssets().getAsset_price() %>"  placeholder="ราคา" style="width: 215px;" readonly>
            ...
            <tr>
                <td>
                    <div class="form-floating">
                        <input type="text" name="sum" id="sum" class="form-control registered" placeholder="หน่วย" value="<%= td.getAssets().getProduct_unit() %>" readonly >
